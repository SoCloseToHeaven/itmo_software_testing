...
public class AviasalesFunctionalTest {
    ...
    // Test case 6: Load favourites page and test navigation by pop up button
    @ParameterizedTest()
    @EnumSource(BrowserDriver.class)
    ...
    // Test case 7: Login via vk and check it in settings
    @ParameterizedTest()
    @EnumSource(BrowserDriver.class)
    ...
    // Test case 8: Open settings menu and personalize
    @ParameterizedTest()
    @EnumSource(BrowserDriver.class)
